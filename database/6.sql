...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2019 at 07:44 PM
...
CREATE TABLE `bungasetoransimpanan` (
  ...
  `sim_kode` int(11) NOT NULL COMMENT 'fk dr simpanan',
...
CREATE TABLE `historibungasimpanan` (
  ...
  `ang_no` int(11) NOT NULL COMMENT 'fk dr anggota',
...
('KD190619001', 'K060619001', 'KAR0001', 'KW001', 2, 2, 1, 10000000, '2019-06-19 00:00:00', NULL, 0, '2019-06-19 20:04:52', 0, '');
...
(1, 'KA080619001', '2019-06-11 20:37:03', 0, 0, 125506, 0, 0, 0, '2019-06-11 20:37:03', 0, ''),
(2, 'KA080619001', '2019-06-11 20:42:22', 0, 0, 125506, 0, 0, 0, '2019-06-11 20:42:22', 0, ''),
(3, 'KA080619001', '2019-06-18 09:47:39', 123045, 2460.9, 125506, 20000, 1255.06, 104251, '2019-06-18 09:47:39', 0, ''),
(4, 'KA180619001', '2019-06-18 10:02:19', 450000, 9000, 459000, 20000, 4590, 434410, '2019-06-18 10:02:19', 0, '');
...
('KE200619001', 'K060619001', 4, 1, 1, 'KW001', 1, 30000000, 25000000, '2019-06-20 00:00:00', NULL, 'KAR0002', 'KAR0001', 'Setuju', '1', '2019-06-20 17:21:13', 0, ''),
('KE240619001', 'K060619001', 5, 1, 1, 'KW002', 1, 8000000, NULL, '2019-06-24 00:00:00', NULL, 'KAR0001', 'KAR0002', 'Tolak', '2', '2019-06-24 09:09:46', 0, '');
...
(15, 'KA180619001', '2019-06-18 10:01:59', 450000, NULL, '2019-06-18 10:01:59', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `setoransimpananpokok`
--

CREATE TABLE `setoransimpananpokok` (
  `ssp_id` int(11) NOT NULL,
  `sip_id` int(11) NOT NULL COMMENT 'fk dari simpanan pokok',
  `ssp_tglsetor` datetime NOT NULL,
  `ssp_jmlsetor` float NOT NULL,
  `ssp_tgl` datetime NOT NULL,
  `ssp_flag` tinyint(4) NOT NULL,
...
(3, 8, '2019-06-08', 20000, '0000-00-00 00:00:00', 0, ''),
(4, 8, '2019-06-10', 40000, '0000-00-00 00:00:00', 0, ''),
(5, 8, '2019-06-10', 41000, '0000-00-00 00:00:00', 0, ''),
(6, 8, '2019-06-11', 40000, '0000-00-00 00:00:00', 0, ''),
(7, 8, '2019-06-11', 21000, '0000-00-00 00:00:00', 0, '');
...
('KA180619001', 'K060619001', 'KAR0002', 4, 1, 2, 'KW001', '2019-06-18 00:00:00', '1', '2019-06-18 09:59:00', 1, '');
...
(11, 'K060619001', 2, 0, '2019-06-06 00:00:00', '2019-06-06 19:38:59', 0, '');
...
--
-- Indexes for table `setoransimpananpokok`
--
ALTER TABLE `setoransimpananpokok`
...
--
ALTER TABLE `penarikansimpanan`
  MODIFY `pes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `penjamin`
  MODIFY `pen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `setoransimpanan`
  MODIFY `ssi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `setoransimpananpokok`
--
ALTER TABLE `setoransimpananpokok`
...
--
ALTER TABLE `setoransimpananwajib`
  MODIFY `ssw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
