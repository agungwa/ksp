...
INSERT INTO `angsuran` (`ags_id`, `pin_id`, `ang_angsuranke`, `ags_tgljatuhtempo`, `ags_tglbayar`, `ags_jmlpokok`, `ags_jmlbunga`, `ags_jmlbayar`, `ags_status`, `ags_tgl`, `ags_flag`, `ags_info`) VALUES
(13, 'KE150719001', 1, '2019-07-12 00:00:00', '2019-07-17 20:28:31', 1666670, 400000, 1666670, 1, '0000-00-00 00:00:00', 0, ''),
(14, 'KE150719001', 2, '2019-09-16 00:00:00', '2019-07-17 17:59:38', 1666670, 400000, 40000, 1, '0000-00-00 00:00:00', 0, ''),
(15, 'KE150719001', 3, '2019-10-16 00:00:00', '0000-00-00 00:00:00', 1666670, 400000, NULL, 0, '0000-00-00 00:00:00', 0, ''),
(16, 'KE150719001', 4, '2019-11-16 00:00:00', '0000-00-00 00:00:00', 1666670, 400000, NULL, 0, '0000-00-00 00:00:00', 0, ''),
(17, 'KE150719001', 5, '2019-12-16 00:00:00', '0000-00-00 00:00:00', 1666670, 400000, NULL, 0, '0000-00-00 00:00:00', 0, ''),
(18, 'KE150719001', 6, '2020-01-16 00:00:00', '0000-00-00 00:00:00', 1666670, 400000, NULL, 0, '0000-00-00 00:00:00', 0, '');
...
--
ALTER TABLE `angsuran`
  MODIFY `ags_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `jaminan`
  MODIFY `jam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `penjamin`
  MODIFY `pen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `simpananpokok`
  MODIFY `sip_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `simpananwajib`
--
ALTER TABLE `simpananwajib`
  MODIFY `siw_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
