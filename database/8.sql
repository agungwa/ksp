...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2019 at 05:18 PM
...
('K010719002', 'Jariyah', ' magelang', '11111111', '111111111', '092892882', '2019-01-01', 1, '2019-07-01 20:43:42', 0, ''),
('K280619001', 'Juminten', ' Temanggung', '66666', '3333', '44444', '2019-06-06', 1, '2019-06-28 19:32:47', 0, '');
...
('KD280619001', 'K280619001', 'KAR0002', 'KW001', 2, 2, 1, 6000000, '2019-06-28 00:00:00', NULL, 0, '2019-06-28 22:12:34', 0, '');
...
INSERT INTO `mutasisimpanan` (`mus_id`, `sim_kode`, `mus_tglmutasi`, `mus_asal`, `mus_tujuan`, `mus_status`, `mus_tgl`, `mus_flag`, `mus_info`) VALUES
(1, 'KA080619001', '2019-06-18 00:00:00', 'KW001', 'KW002', 0, '2019-06-18 08:38:51', 0, '');
...
('KE280619001', 'K280619001', 4, 1, 1, 'KW001', 3, 5000000, 2000000, '2019-06-28 00:00:00', '2019-06-28 22:01:28', 'KAR0002', 'KAR0001', '1ci.png', '1', '2019-06-28 21:33:25', 0, '');
...
(1, 'KA280619001', '2019-06-30 14:40:30', 20000, NULL, '2019-06-30 14:40:30', 0, ''),
(2, 'KA280619001', '2019-07-01 20:45:36', 600000, NULL, '2019-07-01 20:45:36', 0, ''),
(3, 'KA280619001', '2019-07-01 20:45:48', 30000, NULL, '2019-07-01 20:45:48', 0, ''),
(4, 'KA010719001', '2019-07-01 20:45:59', 560000, NULL, '2019-07-01 20:45:59', 0, ''),
(5, 'KA010719001', '2019-07-01 20:46:10', 50000, NULL, '2019-07-01 20:46:10', 0, ''),
(6, 'KB010719002', '2019-07-01 20:47:14', 400000, NULL, '2019-07-01 20:47:14', 0, ''),
(7, 'KB010719002', '2019-07-01 20:47:22', 200000, NULL, '2019-07-01 20:47:22', 0, ''),
(8, 'KB010719002', '2019-07-01 20:47:32', 100000, NULL, '2019-07-01 20:47:32', 0, ''),
(9, 'KB010719002', '2019-07-01 20:47:41', 900000, NULL, '2019-07-01 20:47:41', 0, '');
...
(32, 16, '2019-06-28', 20000, '2019-06-28 19:34:32', 0, ''),
(33, 16, '2019-06-28', 70000, '2019-06-28 19:40:43', 0, ''),
(34, 16, '2019-06-28', 10000, '2019-06-28 20:41:49', 0, ''),
(35, 16, '2019-06-28', 130000, '2019-06-28 20:44:57', 0, ''),
(36, 16, '2019-06-28', 10000, '2019-06-28 20:45:17', 0, ''),
(37, 17, '2019-07-01', 30000, '2019-07-01 20:44:01', 0, ''),
(38, 17, '2019-07-01', 80000, '2019-07-01 20:44:20', 0, '');
...
('KA010719001', 'K010719002', 'KAR0001', 4, 1, 1, 'KW002', '2019-07-01 00:00:00', '0', '2019-07-01 20:45:20', 0, ''),
('KA280619001', 'K280619001', 'KAR0001', 4, 1, 1, 'KW002', '2019-06-28 00:00:00', '0', '2019-06-28 16:42:27', 0, ''),
('KB010719002', 'K010719002', 'KAR0002', 4, 2, 3, 'KW002', '2019-07-01 00:00:00', '0', '2019-07-01 20:46:59', 0, '');
...
(18, 'K280619001', 2, 10000, '2019-06-28 00:00:00', '2019-06-28 19:32:47', 0, ''),
(19, 'K010719002', 2, 10000, '2019-07-01 00:00:00', '2019-07-01 20:43:42', 0, '');
...
(16, 'K280619001', 1, '2019-06-28 19:32:47', 0, NULL, '2019-06-28 19:32:47', 0, ''),
(17, 'K010719002', 1, '2019-07-01 20:43:42', 0, NULL, '2019-07-01 20:43:42', 0, '');
...
--
ALTER TABLE `jaminan`
  MODIFY `jam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `penjamin`
  MODIFY `pen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `setoransimpanan`
  MODIFY `ssi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `setoransimpananwajib`
--
ALTER TABLE `setoransimpananwajib`
  MODIFY `ssw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `simpananpokok`
  MODIFY `sip_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `simpananwajib`
--
ALTER TABLE `simpananwajib`
  MODIFY `siw_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
