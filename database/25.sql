...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2019 at 12:04 PM
...
(1, 'KA020819001', 0, 1400, 71400, 70000, '2019-08-28 00:00:00', '2019-08-28 11:42:25', 0, '');
...
(2, 'dev', '2019-08-28 00:00:00', '2019-08-28 00:00:00', 0, '');
...
(1, 'Admin Pinjaman', '2019-08-20 07:38:18', 0, '');
...
INSERT INTO `karyawan` (`kar_kode`, `kar_nama`, `jab_kode`, `kar_alamat`, `kar_nohp`, `kar_simpanan`, `kar_status`, `kar_tgl`, `kar_flag`, `kar_info`) VALUES
('200819003', 'Erlin', '', 'Temanggung', '0893939393', NULL, 0, '2019-08-20 15:14:29', 0, ''),
('KAR0001', 'Silvi', '	JKB001', 'Parakan', '085666677733', 2000000, 0, '2019-05-20 23:45:40', 0, ''),
('KAR0002', 'joko', 'JMS001', 'Temanggung', '0856645535353', 2000000, 0, '2019-05-30 12:35:22', 0, '');
...
CREATE TABLE `karyawanijasah` (
  ...
  `kij_sd` varchar(25) NOT NULL,
  `kij_smp` varchar(25) NOT NULL,
  `kij_sma` varchar(25) NOT NULL,
  `kij_d3` varchar(25) NOT NULL,
  `kij_s1` varchar(25) NOT NULL,
  `kij_s2` varchar(25) NOT NULL,
  `kij_s3` varchar(25) NOT NULL,
  `kij_lainlain` varchar(25) NOT NULL,
...
(1, 200819003, '9249429i439i', '4235dsf', '', '', '', '', 'as42435235', '', 0, '2019-08-20 15:14:29', 0, '');
...
(1, '200819003', 2000000, 0, '2019-08-20 15:14:29', 0, '');
...
INSERT INTO `neracaekuitas` (`nek_id`, `nek_tanggal`, `nek_simpanancdr`, `nek_donasi`, `nek_tgl`, `nek_flag`, `nek_info`) VALUES
(1, '2019-08-08 00:00:00', 500000, 30000, '2019-08-10 04:17:11', 0, ''),
(2, '2019-08-02 00:00:00', 600000, 500000, '2019-08-10 04:17:39', 0, '');
...
INSERT INTO `neracakewajibanjangkapanjang` (`njp_id`, `njp_tanggal`, `njp_rekeningkoran`, `njp_modalpenyertaan`, `njp_tgl`, `njp_flag`, `njp_info`) VALUES
(1, '2019-08-10 00:00:00', 500000, 6000000, '2019-08-10 04:20:47', 0, ''),
(2, '2019-08-10 00:00:00', 900000, 700000, '2019-08-10 04:21:52', 0, '');
...
(1, 'KA020819001', '2019-08-28 11:46:45', 70000, 1400, 71400, 20000, 714, 50686, '2019-08-28 11:46:45', 0, '');
...
(2, 'KE120819001', '2019-08-12 07:36:17', '2019-08-12 07:36:17', 50000, 0, '2019-08-12 07:36:17', 0, ''),
(3, 'KE120819002', '2019-08-12 08:19:22', '2019-08-12 08:19:22', 100000, 0, '2019-08-12 08:19:22', 0, '');
...
('KE120819001', 'K020819003', 'KAR0001', 1, 'KW002', '2019-08-12 00:00:00', NULL, 0, '2019-08-12 07:36:02', 0, ''),
('KE120819002', 'K020819002', 'KAR0002', 2, 'KW001', '2019-08-12 00:00:00', NULL, 0, '2019-08-12 08:18:28', 0, '');
...
('KA020819001', 'K020819002', 'KAR0001', 4, 1, 2, 'KW001', '2019-08-02 00:00:00', '1', '2019-08-02 17:14:57', 1, ''),
('KA020819002', 'K020819003', 'KAR0001', 4, 1, 1, 'KW001', '2019-08-02 00:00:00', '0', '2019-08-02 17:15:10', 1, '');
...
INSERT INTO `titipansimkesan` (`tts_id`, `sik_kode`, `tts_tgltitip`, `tts_jmltitip`, `tts_jmlambil`, `tts_status`, `tts_tgl`, `tts_flag`, `tts_info`) VALUES
(6, 'KE120819002', '2019-08-12 08:36:40', 100000, 0, 0, '2019-08-12 08:36:40', 0, ''),
(7, 'KE120819002', '2019-08-12 08:36:42', 100000, 0, 0, '2019-08-12 08:36:42', 0, ''),
(8, 'KE120819002', '2019-08-12 08:36:53', 100000, 0, 0, '2019-08-12 08:36:53', 0, ''),
(10, 'KE120819001', '2019-08-12 08:38:35', 50000, 0, 0, '2019-08-12 08:38:35', 0, ''),
(11, 'KE120819001', '2019-08-12 08:38:40', 100000, 0, 0, '2019-08-12 08:38:40', 0, ''),
(12, 'KE120819001', '2019-08-12 08:38:48', 100000, 0, 0, '2019-08-12 08:38:48', 0, ''),
(13, 'KE120819002', '2019-08-12 08:52:15', 100000, 0, 0, '2019-08-12 08:52:15', 0, '');
...
--
ALTER TABLE `ahliwarissimkesan`
  MODIFY `aws_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `bungasetoransimpanan`
  MODIFY `bss_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `historibungasimpanan`
  MODIFY `hbs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `jabatan`
--
ALTER TABLE `jabatan`
  MODIFY `jab_kode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `karyawanijasah`
  MODIFY `kij_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `karyawansimpanan`
--
ALTER TABLE `karyawansimpanan`
  MODIFY `ksi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `keluargakaryawan`
--
ALTER TABLE `keluargakaryawan`
  MODIFY `kka_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `setoransimkesan`
  MODIFY `ssk_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
