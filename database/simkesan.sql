...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2019 at 06:43 PM
...
(8, 'KE300819001', '452345', 'KTP', 'Juminten', 'Magelang', 'Istri', 'Kurang KK', '2019-08-30 22:11:23', 0, '');
...
INSERT INTO `jaminan` (`jam_id`, `pin_id`, `jej_id`, `jam_nomor`, `jam_unit`, `jam_noregistrasi`, `jam_tahunpembuatan`, `jam_atasnama`, `jam_keterangan`, `jam_file`, `jam_tgl`, `jam_flag`, `jam_info`, `jam_alamat`) VALUES
(23, 'KE270819001', 1, '123456789', 'SEPEDAMOTOR mio', 'AA 2345 H', '2016', 'ERLIN AMALYA', 'kurang sk3', '', '2019-08-27 13:18:50', 0, '', 'parakan'),
(24, 'KE270819002', 1, '123456789', 'SEPEDAMOTOR mio', 'AA 1234 T', '2016', 'ERLIN AMALYA', '', '', '2019-08-27 13:38:44', 0, '', 'PARAKAN'),
(25, 'KE270819003', 1, '123456', 'SEPEDAMOTOR', 'AA 2345 H', '2015', 'ERLIN AMALYA', '', '', '2019-08-27 13:45:09', 0, '', 'PARAKAN'),
(26, 'KE280819001', 1, '236455', 'sepeda motor', 'aa 1245 h', '2018', 'erlin', '', '', '2019-08-28 12:34:48', 0, '', 'parakan');
...
(11, 'M_UTILITAS', 'M_UTILITAS', '2019-08-30 17:58:07', 1);
...
(2, '2019-08-30 00:00:00', 600000000, '2019-08-30 20:59:25', 0, '');
...
INSERT INTO `phusimkesan` (`phus_id`, `phus_insentif`, `phus_gaji`, `phus_promosi`, `phus_lainlain`, `phus_tgl`, `phus_flag`, `phus_info`) VALUES
(3, 90000000, 89000000, 5000000, 1000000, '2019-08-30 18:57:32', 1, '');
...
CREATE TABLE `phu_sistem` (
  ...
  `psis_lainlain` float DEFAULT NULL COMMENT 'pendapatan',
...
(8, 'KE300819001', '2019-08-30 22:11:49', '2019-08-30 22:11:49', 100000, 0, '2019-08-30 22:11:49', 0, '');
...
('KE300819001', 'K280819012', '2708006', 2, '11', '2019-08-30 00:00:00', NULL, 0, '2019-08-30 22:11:23', 0, '');
...
--
ALTER TABLE `ahliwarissimkesan`
  MODIFY `aws_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `angsuran`
--
ALTER TABLE `angsuran`
  MODIFY `ags_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
...
--
ALTER TABLE `jaminan`
  MODIFY `jam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `neracakasbank`
  MODIFY `nkb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `penjamin`
  MODIFY `pen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `phusimkesan`
  MODIFY `phus_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `setoransimkesan`
  MODIFY `ssk_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `setoransimpanan`
--
ALTER TABLE `setoransimpanan`
  MODIFY `ssi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `setoransimpananwajib`
--
ALTER TABLE `setoransimpananwajib`
  MODIFY `ssw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `simpananpokok`
  MODIFY `sip_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `simpananwajib`
--
ALTER TABLE `simpananwajib`
  MODIFY `siw_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `titipansimkesan`
  MODIFY `tts_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
