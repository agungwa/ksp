...
class Karyawanijasah_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $where = "(kar_kode LIKE '%$q%' ESCAPE '!' OR kij_id LIKE '%$q%' ESCAPE '!') AND kij_flag < 2";
        $this->db->where($where);
...
/* End of file Karyawanijasah_model.php */
/* Location: ./application/models/Karyawanijasah_model.php */
