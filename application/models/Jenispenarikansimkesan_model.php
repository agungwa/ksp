...
class Jenispenarikansimkesan_model extends CI_Model
{

    public $table = 'jenispenarikansimkesan';
    public $id = 'jps_id';
    public $order = 'DESC';
...
/* End of file Jenispenarikansimkesan_model.php */
/* Location: ./application/models/Jenispenarikansimkesan_model.php */
