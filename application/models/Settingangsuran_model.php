...
class Settingangsuran_model extends CI_Model
{

    public $table = 'settingangsuran';
    public $id = 'sea_id';
    public $order = 'DESC';
...
/* End of file Settingangsuran_model.php */
/* Location: ./application/models/Settingangsuran_model.php */
