...
class Plansimkesan_model extends CI_Model
{

    public $table = 'plansimkesan';
    public $id = 'psk_id';
    public $order = 'DESC';
...
/* End of file Plansimkesan_model.php */
/* Location: ./application/models/Plansimkesan_model.php */
