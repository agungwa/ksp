...
<html>
    ...
    <div class="row">
		...
		<th class="text-center">Lln Info</th>
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('lainlain/read/'.$lainlain->lln_id),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('lainlain/update/'.$lainlain->lln_id),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('lainlain/delete/'.$lainlain->lln_id),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
