            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
        			<div class="row" style="margin-bottom: 10px">
                        ...
                        <li role="presentation" class="<?= ($active==8)?'active':''?>"><a href="<?=base_url()?>simpanan/?p=8">Setup</a></li>
                        <li role="presentation" class="<?= ($active==5)?'active':''?>"><a href="<?=base_url()?>simpanan/?p=5">Setoran</a></li>
                        <li role="presentation" class="<?= ($active==4)?'active':''?>"><a href="<?=base_url()?>simpanan/?p=4">Tarik</a></li>
						...
						<li role="presentation" class="<?= ($active==6)?'active':''?>"><a href="<?=base_url()?>simpanan/?p=6">List Setoran</a></li>
