<div class="row">
    ...
    <form action="<?php echo site_url('simpanan/simpananb_action'); ?>" method="post">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
            <input type="hidden" name="jse_id" id="jse_id" value="" required="required" />
            <input type="text" class="form-control" name="nm_jse_id" id="nm_jse_id" placeholder="Jenis Setoran" value="" required="required" readonly/>
            <div class="input-group-addon">
