<div class="row">
    ...
    <form action="<?php echo site_url('simpanan/simpananb_action'); ?>" method="post">
        <div class="ibox-content col-md-12">
        <h3>Form Simpanan Jangka 12 Bulan</h3>
        <div class="col-md-6">
	    <div class="form-group col-md-12">
            <label for="varchar">Kode Simpanan </label>
            <input type="text" class="form-control" name="sim_kode" id="sim_kode" placeholder="Kode Simpanan" value="<?php echo $kode; ?>" readonly required />
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name="nm_kar_kode" id="nm_kar_kode" placeholder="Karyawan" required autocomplete="off" onkeypress="return false"/>
            <div class="input-group-addon">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name="nm_jse_id" id="nm_jse_id" placeholder="Jenis Setoran" required autocomplete="off" onkeypress="return false"/>
            <div class="input-group-addon">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name="nm_wil_kode" id="nm_wil_kode" placeholder="Wilayah" required autocomplete="off" onkeypress="return false"/>
            <div class="input-group-addon">
