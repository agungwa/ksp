...
<html>
    ...
    <div class="row">
		...
		<th class="text-center">Sim Info</th>
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('simpanan/read/'.$simpanan->),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('simpanan/update/'.$simpanan->),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('simpanan/delete/'.$simpanan->),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
