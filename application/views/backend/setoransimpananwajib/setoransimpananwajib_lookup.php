...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('setoransimpananwajib/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>setoransimpananwajib/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Jumlah Setor</th></tr>
            </thead>
			<tbody><?php
