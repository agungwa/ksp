...
<table class="table table-bordered table-hover table-condensed" style="margin-bottom: 10px">
    ...
    $totalbelum = 0;
    $totalsudah = 0;
    foreach ($angsuranbelum as $key)
    {
        $totalbelum++;
    } 
    foreach ($angsuransudah as $key2)
    {
        $totalsudah++;
    }
    foreach ($histori as $item)
    {
        ...
        <div class="ibox-content">
                ...
                <tr><td>Total Kurang Pokok</td><td><?php echo rupiah(($pinjaman['sea_id']*ceiling($item->ags_jmlpokok,1000)) - $hitungtotalangsuran[0]->agb_pokok)?><input type="hidden" class="form-control" name="pel_totalkekuranganpokok" id="pel_totalkekuranganpokok" placeholder="<?php echo ($pinjaman['sea_id']*ceiling($item->ags_jmlpokok,1000)) - $hitungtotalangsuran[0]->agb_pokok; ?>" value="<?php echo ceiling(($pinjaman['sea_id']*$item->ags_jmlpokok) - $hitungtotalangsuran[0]->agb_pokok,1000); ?>" readonly/></td></tr>
                <tr><td>Total Kurang Bunga</td><td><input type="number" class="form-control" name="pel_totalbungapokok" id="pel_totalbungapokok" value="<?php echo (($datatglsekarang->ang_angsuranke+1)*ceiling($item->ags_jmlbunga,1000)) - $hitungtotalangsuran[0]->agb_bunga; ?>" /></td></tr>
                ...
                <tr><td></td><td><a href="<?php echo site_url('pelunasan/?p=1') ?>" class="btn btn-default">Batal</a>
