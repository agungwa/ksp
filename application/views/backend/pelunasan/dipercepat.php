...
<table class="table table-bordered table-hover table-condensed" style="margin-bottom: 10px">
    ...
    foreach ($histori as $item)
    {
        ...
        <div class="ibox-content">
                ...
                <tr><td>Pokok Bayar</td><td><?php echo rupiah($item->ags_jmlpokok*$totalsudah)?><input type="hidden" class="form-control" name="pel_pokoksudahbayar" id="pel_pokoksudahbayar" placeholder="<?php echo ceiling($item->ags_jmlpokok*$datatglsekarang->ang_angsuranke,1000); ?>" value="<?php echo ceiling($item->ags_jmlpokok*$datatglsekarang->ang_angsuranke,1000); ?>" readonly/></td></tr>
                <tr><td>Total Kurang Pokok</td><td><?php echo rupiah($item->ags_jmlpokok*$totalbelum)?><input type="hidden" class="form-control" name="pel_totalkekuranganpokok" id="pel_totalkekuranganpokok" placeholder="<?php echo ceiling($item->ags_jmlpokok*$kali,1000); ?>" value="<?php echo ceiling($item->ags_jmlpokok*$kali,1000); ?>" readonly/></td></tr>
