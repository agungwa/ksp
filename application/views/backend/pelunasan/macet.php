    ...
    <div class="col-lg-12">
        ...
        <div class="row" style="margin-bottom: 10px, margin-top:10px">
            <form action="<?php echo site_url('pelunasan/macet/'); ?>" class="form-inline" method="get">
...
<table class="table table-bordered table-hover table-condensed" style="margin-bottom: 10px">
    ...
    foreach ($histori as $item)
    {
        ...
        <div class="ibox-content">
                ...
                <tr><td>Total Kurang Pokok</td><td><?php echo rupiah(($pinjaman['sea_id']*ceiling($item->ags_jmlpokok,1000)) - $hitungtotalangsuran[0]->agb_pokok)?><input type="hidden" class="form-control" name="pel_totalkekuranganpokok" id="pel_totalkekuranganpokok" value="<?php echo ($pinjaman['sea_id']*ceiling($item->ags_jmlpokok,1000)) - $hitungtotalangsuran[0]->agb_pokok; ?>" readonly/></td></tr>
                <tr><td>Total Kurang Bunga</td><td><?php echo rupiah(($pinjaman['sea_id']*ceiling($item->ags_jmlbunga,1000)) - $hitungtotalangsuran[0]->agb_bunga)?><input type="hidden" class="form-control" name="pel_totalbungapokok" id="pel_totalbungapokok" value="<?php echo ($pinjaman['sea_id']*ceiling($item->ags_jmlbunga,1000)) - $hitungtotalangsuran[0]->agb_bunga; ?>" readonly/></td></tr>
                <input type="hidden" class="form-control" name="pel_bungatambahan" id="pel_bungatambahan" value="<?php echo 0; ?>" readonly/></td></tr>
                ...
                <tr><td>Total Denda</td><td><input type="number" class="form-control" name="pel_totaldenda" id="pel_totaldenda" placeholder="<?php echo ceiling($totaldenda-$hitungtotalangsuran[0]->agb_denda,1000); ?>" value="<?php echo ceiling($totaldenda-$hitungtotalangsuran[0]->agb_denda,1000); ?>"/></td></tr>
