...
<html>
    ...
    <div class="row">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-8">
                <?php echo anchor(site_url('jasainvestasi/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('jasainvestasi/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('jasainvestasi'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' | '; 
				echo anchor(site_url('jasainvestasi/update/'.$jasainvestasi->jiv_id),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('jasainvestasi/delete/'.$jasainvestasi->jiv_id),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
