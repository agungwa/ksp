...
<html>
    ...
    <div class="row">
        ...
        <div class="form-group">
            <label for="varchar">Jenis Jaminan<?php echo form_error('jej_id') ?></label>
            <div class="input-group">
	    ...
	    <div class="form-group">
            <label for="varchar">Nomor Jaminan <?php echo form_error('jam_nomor') ?></label>
            <input type="text" class="form-control" name="jam_nomor" id="jam_nomor" placeholder="Nomor Jaminan" value="<?php echo $jam_nomor; ?>" />
        </div>
	    <div class="form-group">
            <label for="jam_keterangan">Keterangan <?php echo form_error('jam_keterangan') ?></label>
	    ...
	    <a href="<?php echo site_url('jaminan') ?>" class="btn btn-default">Batal</a>
        </div>
	</div>
            </form>
        </div>
