...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('temp_setoransimpanan/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>temp_setoransimpanan/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Tes Periode</th></tr>
            </thead>
			<tbody><?php
