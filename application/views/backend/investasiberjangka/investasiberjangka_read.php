...
<html>
    ...
    <div class="ibox float-e-margins">
	    ...
	    <tr><td></td><td><a href="<?php echo base_url()?>Printinvestasiberjangka/read/<?=$ivb_kode?>" class="btn btn-default">Print</a><a href="<?php echo site_url('investasiberjangka/?p=2') ?>" class="btn btn-default">Batal</a></td></tr>
	</table>
            </div>
        </div>
    </div>
