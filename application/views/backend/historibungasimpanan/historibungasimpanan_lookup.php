...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('historibungasimpanan/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>historibungasimpanan/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Tanggal Terakhir</th></tr>
            </thead>
			<tbody><?php
