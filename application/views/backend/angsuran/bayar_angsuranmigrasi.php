		...
		<form action="<?php echo site_url('angsuran/bayarAngsuranv2_action/'.$angsuran['ags_id']); ?>" method="post">
	        	...
	        	<table class="table">
					...
					<?php if ($pokok < $angsuran['ags_jmlpokok'] ) {
						...
						<td>
						<input readonly type="text" class="form-control numeric" name="agb_pokok" id="searchTxt" value ="<?php echo ceiling($angsuran['ags_jmlpokok'],1000); ?>"  placeholder="<?php echo rupiah($angsuran['ags_jmlpokok']-$pokok); ?>" />
						<input readonly class="form-control" name="agb_tglpokok" value ="<?php echo $angsuran['ags_tglbayar']; ?>" placeholder="tanggal pokok" />
					...
					<input readonly readon class="form-control" name="agb_tglbunga" value ="<?php echo $angsuran['ags_tglbayar']; ?>" placeholder="tanggal bunga" required />
					</td>
					</td>
					</tr><?php
					}
					...
					<?php if ($denda < 1) {
						...
						<tr><td>Denda</td>
						<td>
						<input type="text" class="form-control numeric" name="agb_denda" value ="<?php echo ceiling($angsuran['ags_denda'],1000); ?>" placeholder="<?php echo rupiah($angsuran['denda']-$denda); ?>" />
						<input readonly class="form-control" name="agb_tgldenda" value ="<?php echo $angsuran['ags_tglbayar']; ?>" placeholder="tanggal denda"  />
