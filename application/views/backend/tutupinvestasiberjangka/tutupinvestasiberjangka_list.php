...
<html>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2><b>List Tutup Investasi Berjangka</b></h2>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-8">
                <?php echo anchor(site_url('tutupinvestasiberjangka/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('tutupinvestasiberjangka'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' | '; 
				echo anchor(site_url('tutupinvestasiberjangka/update/'.$tutupinvestasiberjangka->tib_id),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('tutupinvestasiberjangka/delete/'.$tutupinvestasiberjangka->tib_id),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
