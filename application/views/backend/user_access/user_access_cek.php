...
<label class="switch">
  <input type="checkbox" id="cek-<?=$user_access->id?>" onclick="aktifkan(<?=$user_access->id?>,<?=$user_access->id_user_group?>,<?=$user_access->id_master_access?>)" <?=$this->User_access_model->get_isallow($user_access->id_user_group,$user_access->id_master_access)?"checked":"";?>/>
